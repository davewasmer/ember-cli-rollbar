...
module.exports = {
  ...
  contentFor: function(type) {
    if (type === 'head') {
      ...
      var root = this.app.project.root;
      var configPath = path.join(root, 'config', 'environment');
      var configModule = require(configPath);
      var config = configModule(environment);
      var clientToken = config.rollbarClientToken;
